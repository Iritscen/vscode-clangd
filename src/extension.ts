...
export async function activate(context: vscode.ExtensionContext):
  ...
  context.subscriptions.push(
    ...
    vscode.workspace.onDidChangeConfiguration((conf) =>
    {
      ...
      else if (conf.affectsConfiguration('clangd.diagnosticsDelay.untilFileSave') && clangdContext)
        clangdContext.diagnosticsWaitForFileSave = vscode.workspace.getConfiguration('clangd').get<boolean>('diagnosticsDelay.untilFileSave') ?? false;
      })
  );
